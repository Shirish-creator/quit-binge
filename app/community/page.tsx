  ...
  return (
    <main className="flex flex-col relative gap-0 h-full bg-[#FFF9F3]">
      <div className="h-[116px] px-6 w-full items-end pt-16 z-1 bg-white rounded-b-[32px]" style={{boxShadow: '0 -4px 0 0 rgba(0, 0, 0, 0.15) inset'}}> 
        <div className="flex flex-row">
          <div className="flex flex-row items-center gap-6">
            <div className="rounded-full border-1 border-gray-400 w-8 h-8 flex items-center justify-center"> 
      ...
      <div className="flex flex-col gap-4 pt-8 px-6 items-center">
        <h2 className="font-bold text-lg">Join the Community</h2>
        <p className="text-center text-gray-600">Connect with others on their journey</p>
      </div>
    </main>
  );
}
